...
local distance_color = ui.new_color_picker("VISUALS", "Other ESP", "Distance Color", 255, 255, 255, 255)
...
local function draw_distance_indicator()
    ...
    -- 绘制边框（如果鼠标悬停则高亮）
    local border_color = in_area and 255 or 100
    renderer.rectangle(x, y, indicator_width, 1, border_color, border_color, border_color, smooth_alpha) -- 上边框
    renderer.rectangle(x, y + indicator_height - 1, indicator_width, 1, border_color, border_color, border_color, smooth_alpha) -- 下边框
    renderer.rectangle(x, y, 1, indicator_height, border_color, border_color, border_color, smooth_alpha) -- 左边框
    renderer.rectangle(x + indicator_width - 1, y, 1, indicator_height, border_color, border_color, border_color, smooth_alpha) -- 右边框
