...
local new_check, new_color_picker, new_slider, new_multiselect, ui_ref =
	ui.new_checkbox, ui.new_color_picker, ui.new_slider, ui.new_multiselect, ui.reference

local create_interface, screen_size, set_event_callback, unset_event_callback = 
	client.create_interface, client.screen_size, client.set_event_callback, client.unset_event_callback

local get_lp, get_player_wpn, get_prop, is_alive =
	entity.get_local_player, entity.get_player_weapon, entity.get_prop, entity.is_alive
